...
Data contributing to this analysis is described in [Property Data Description](property-data-description.html). 
...
#| fig-cap: Large landlords control almost 70% of the approximately 53000 units available in Lancaster county which are not owner-occupied.
tmp <- rental_info %>%
